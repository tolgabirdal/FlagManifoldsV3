...
def SubspaceNetHead(query1, query2, support1, support2, support_labels, n_way, n_shot, normalize=True):
    """
...
def ProtoNetHead(query1, query2, support1, support2, support_labels, n_way, n_shot, normalize=True):
    """
